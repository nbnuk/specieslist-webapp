            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <span class="pull-right">
                        <a class="btn btn-default" title="Add Species List" href="${request.contextPath}/speciesList/upload">Upload a list</a>
                        <a class="btn btn-default" title="My Lists" href="${request.contextPath}/speciesList/list">My Lists</a>
                        <a class="btn btn-default" title="Rematch" href="${request.contextPath}/speciesList/rematch">Rematch All</a>
                    </span>
                </div>
            </div><!--inner-->
        </header>
